...
public class PowerConnectionReceiver extends BroadcastReceiver {
    ...
    public PowerConnectionReceiver(ProgressBar mBatteryLevelProgress, TextView mBatteryLevelText) {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        mBatteryLevelText.setText("Level is" + " " + level);
    ...
    public void checking(Context context,Boolean charger){
        ...
        if(curLevel <= 15 && !charger) {
            noti = new Notification.Builder(context).setTicker("Title")
                    .setContentTitle("Battery low")
                    .setContentText("Battery " + curLevel + "% Connect Charger")
            ...
            noti = new Notification.Builder(context).setTicker("Ticker Title")
                    ...
                    .setContentText("Battery full disconnect Charger")
                    .setSmallIcon(R.mipmap.ic_launcher)
                    .setContentIntent(pIntent).getNotification();
            noti.flags = Notification.FLAG_AUTO_CANCEL;
            NotificationManager nm = (NotificationManager) context.getSystemService(NOTIFICATION_SERVICE);
